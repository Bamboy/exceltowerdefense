...
// Matt McGrath - 5/11/2015

// First ATTEMPT at the projectile that the Player Tower will use. I'm attempting a slingshot approach using a Spring Joint, though I'm not sure if this will work for our 3D aiming needs.
// If I can't do this working I'll just do a simple mortar-type system where you click ground you want to aim at and it automatically launches there. Less skill required for player though.
// TODO and Issues: You have to remove the spring joint to launch the projectile. You can't disaable and re-enable it, meaning we have to create new spring after each launch.
